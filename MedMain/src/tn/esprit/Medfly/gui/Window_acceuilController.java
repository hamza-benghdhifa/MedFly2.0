 ...
 * @author Dell
 */
public class Window_acceuilController implements Initializable {

    @FXML
    private Button patien;
...
private Stage stage;
    ...
    @FXML
    private void espace_gest(ActionEvent event) {
         try {
    ...
    @FXML
    private void espace_pat(ActionEvent event) {
         try {
